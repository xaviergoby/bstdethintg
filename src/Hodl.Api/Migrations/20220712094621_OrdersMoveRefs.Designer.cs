...
namespace Hodl.Api.Migrations
{
    ...
    [Migration("20220712094621_OrdersMoveRefs")]
    partial class OrdersMoveRefs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hodl.Api.HodlDbDomain.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "329213d2-073c-4fb9-875c-2f71ca70da2d",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "221ca64e-4cbe-4f0c-80a4-580522382bb2",
                            Name = "Trader",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "0601b0ef-6e2a-4053-8086-ce72e123335a",
                            Name = "LeadTrader",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "cf521ed5-3cce-4168-ac7b-ec79f7cad7f2",
                            Name = "Sales",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "28256c90-91d5-49c8-b8ad-62cb979e733e",
                            Name = "HeadSales",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "fbe2dc3f-1997-4b0d-8738-66864eb5cdbc",
                            Name = "Client",
            ...
            modelBuilder.Entity("CryptoCategories", b =>
                {
                    b.HasOne("Hodl.Api.HodlDbDomain.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();

                    b.HasOne("Hodl.Api.HodlDbDomain.CryptoCurrency", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Hodl.Api.HodlDbDomain.Order", b =>
                {
                    ...
                    b.HasOne("Hodl.Api.HodlDbDomain.Pair", "Pair")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Hodl.Api.HodlDbDomain.Pair", b =>
                {
                    b.HasOne("Hodl.Api.HodlDbDomain.CryptoCurrency", "FromCurrency")
                        .WithMany("FromPairs")
                        .HasForeignKey("FromCryptoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hodl.Api.HodlDbDomain.CryptoCurrency", "ToCurrency")
                        .WithMany("ToPairs")
