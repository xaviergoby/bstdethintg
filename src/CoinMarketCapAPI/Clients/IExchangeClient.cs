...
public interface IExchangeClient
{
    ...
    /// </param>
    /// <returns></returns>
    Task<ResponseMain<Dictionary<string, QuotesLatestData>>> GetQuotesLatest(string slug, string[] convert);
    Task<ResponseMain<Dictionary<string, QuotesLatestData>>> GetQuotesLatest(long id, string[] convert);
}