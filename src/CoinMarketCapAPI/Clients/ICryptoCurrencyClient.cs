...
public interface ICryptoCurrencyClient
{
    ...
    /// </param>
    /// <returns></returns>
    Task<ResponseMain<Dictionary<string, CryptoCurrencyInfoData[]>>> GetMetaData(string[] symbol);

    Task<ResponseMain<Dictionary<long, CryptoCurrencyInfoData>>> GetMetaData(long[] id);
    ...
    /// </param>
    /// <returns></returns>
    Task<ResponseMain<IdMapData[]>> GetIdMap(string listingStatus, int? start, int? limit, string sort, string[] symbol);
    ...
    /// </param>
    /// <returns></returns>
    Task<ResponseMain<IdMapData[]>> GetIdMap(int? limit, string sort);
    ...
    /// </param>
    /// <returns></returns>
    Task<ResponseMain<MarketPairsLatestData>> GetMarketPairLatest(string symbol, int? start, int? limit, string[] convert);

    Task<ResponseMain<MarketPairsLatestData>> GetMarketPairLatest(long id, int? start, int? limit, string[] convert);
    ...
    /// </param>
    /// <returns></returns>
    Task<ResponseMain<OhlcvHistoricalData>> GetOhlvcHistorical(string symbol, string timePeriod,
        string timeStart, string timeEnd, int? count, string interval, string[] convert);

    Task<ResponseMain<OhlcvHistoricalData>> GetOhlvcHistorical(long id, string timePeriod,
        string timeStart, string timeEnd, int? count, string interval, string[] convert);
    ...
    /// </param>
    /// <returns></returns>
    Task<ResponseMain<Dictionary<string, OhlcvLatestData>>> GetOhlcvLatest(string[] symbol, string[] convert);

    Task<ResponseMain<Dictionary<long, OhlcvLatestData>>> GetOhlcvLatest(long[] id, string[] convert);
    ...
    /// </param>
    /// <returns></returns>
    Task<ResponseMain<QuotesHistoricalData>> GetQuotesHistorical(string symbol,
        string timeStart, string timeEnd, int? count, string interval, string[] convert);

    Task<ResponseMain<QuotesHistoricalData>> GetQuotesHistorical(long id,
        string timeStart, string timeEnd, int? count, string interval, string[] convert);
    ...
    /// </param>
    /// <returns></returns>
    Task<ResponseMain<Dictionary<string, QuotesLatestData>>> GetQuotesLatest(string[] symbol, string[] convert);

    Task<ResponseMain<Dictionary<long, QuotesLatestData>>> GetQuotesLatest(long[] id, string[] convert);
}